...
• `Optional` **disabled**: [`DisableOptionValueType`](../Types/DisableOptionType.md#disableoptionvaluetype) \| (`fieldId`: `string`) => `boolean`
...
List GUID Id or title for getting list field. Keep undefined for web field. Changing list value refreshes response data.. <ToolTip text="Changing list value refreshes response data.">🚩</ToolTip>
