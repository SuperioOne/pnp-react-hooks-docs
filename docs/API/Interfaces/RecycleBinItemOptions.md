...
• `Optional` **disabled**: [`DisableOptionValueType`](../Types/DisableOptionType.md#disableoptionvaluetype) \| (`itemId`: `string`) => `boolean`
...
Recycle bin scope. Available options are `"site"` and `"web"`. Default value is `"web"`. <ToolTip text="Changing scope type refreshes response data.">🚩</ToolTip>
___
